...
#ifndef CONFIG_LGE_ANDROID_USB_NMEA
...
/* 					
	...
	========================================================
 */
//20110330 yongman.kwon@lge.com [LS855] for support Factory USB PID [START]
//gserial_setup call by acm.
#ifndef CONFIG_LGE_USB_GADGET_SUPPORT_FACTORY_USB
	if (ret == 0)
		gserial_setup(c->cdev->gadget, 3);
#endif 
//20110330 yongman.kwon@lge.com [LS855] for support Factory USB PID [END]
