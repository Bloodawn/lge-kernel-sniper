...
DEVICE_ATTR(backlight_on_off, 0666, lcd_backlight_show_on_off, lcd_backlight_store_on_off);//20100825 kyungtae.oh@lge.com for test_mode
DEVICE_ATTR(gpio_test, 0666, gpio_test_show, gpio_test_store);//20100907 kyungtae.oh@lge.com for gpio_test
