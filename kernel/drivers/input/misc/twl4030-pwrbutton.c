...
#endif
// 20110331 youngmin.kim@lge.com, KEY(power,gesture) resume check. for LED [START_LGE]
extern void resumekey_pressed();
// 20110331 youngmin.kim@lge.com, KEY(power,gesture) resume check. for LED [END_LGE]
