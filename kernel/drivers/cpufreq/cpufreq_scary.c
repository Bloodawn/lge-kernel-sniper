...
#define DEFAULT_SLEEP_MIN_FREQ 120000
#define DEFAULT_SLEEP_PREV_FREQ 120000 //This is so that if there are any issues resulting in sleep_prev_freq getting set, there will be a backup freq
#define DEFAULT_PREV_MAX 1400000
