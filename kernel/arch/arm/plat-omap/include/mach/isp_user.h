...
#define V4L2_CID_PRIVATE_OMAP3ISP_HYNIX_SMART_CAMERA	(V4L2_CID_PRIVATE_BASE + 2)
/* Boolean control used to toggle Hynix secondary camera in Video Telephony mode */
#define V4L2_CID_PRIVATE_OMAP3ISP_HYNIX_SMART_CAMERA_VT	(V4L2_CID_PRIVATE_BASE + 3)
